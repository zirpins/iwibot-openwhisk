...
ibmcloud functions service bind conversation --instance ${conversation_service_name} Router
#create api
ibmcloud functions api create /iwibotDev /router POST Router --response-type http
#remove zip file
rm action.zip